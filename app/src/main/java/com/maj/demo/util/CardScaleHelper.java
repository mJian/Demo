...
public class CardScaleHelper {
    ...
    public void attachToRecyclerView(final RecyclerView mRecyclerView) {
        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                LogUtils.i("",String.format("dx=%s, dy=%s, mScrolledX=%s", dx, dy, mCurrentItemOffset));
    ...
    private void initWidth() {
        mRecyclerView.post(new Runnable() {
            ...
            public void run() {
                ...
                mCardWidth = mCardGalleryWidth - ToolsUtil.dip2px(mContext, 2 * (mPagePadding + mShowLeftCardWidth));
    ...
    private void computeCurrentItemPos() {
        ...
        if (pageChanged) {
            ...
            LogUtils.i("", String.format("=======onCurrentItemPos Changed======= tempPos=%s, mCurrentItemPos=%s", tempPos, mCurrentItemPos));
        }
    }
    ...
    private void onScrolledChangedCallback() {
        ...
        LogUtils.i("",String.format("offset=%s, percent=%s", offset, percent));
        View leftView = null;
        View currentView;
        View rightView = null;
